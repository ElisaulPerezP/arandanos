        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @if ($cultivo && (!$cultivo->estadoActual || ($cultivo->estadoActual && $cultivo->estadoActual->nombre === 'Inactivo')))
                        <div class="mt-6">
                    ...
                    @endif
                    <!-- Botón para detener el sistema si el estado es activo -->
                    @if ($cultivo && $cultivo->estadoActual && $cultivo->estadoActual->nombre === 'Activo')
                        <div class="mt-6">
                    ...
                    @endif
                    <!-- Botón para sincronizar cultivo -->
                    <div class="mt-6">
                        <a href="{{ url('system/sync') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                            {{ __('Sincronizar Cultivo') }}
                        </a>
                    </div>
                </div>
            </div>
